    ...
    <Modal className="modal-style-sidenav" centered show={props.show}>
      <Modal.Header>
        <div className="d-flex">
          <img src={Logo} alt="nav-logo-sidenav" className="nav-logo-sidenav" />
          <img
            src={CompanyName}
      ...
      <Modal.Body>
        ...
        <div className="d-flex section">
          <a href="/home" className="logo-title">
            ...
            ></img>
            <span class="title-sidenav">Devices</span>
          </a>
        </div>
        <div className="d-flex section">
          <a href="/home" className="logo-title">
            ...
            ></img>
            <span class="title-sidenav">Account</span>
          </a>
        </div>
        <div className="d-flex section">
          <a href="/home" className="logo-title">
            ...
            ></img>
            <span class="title-sidenav">Logout</span>
          </a>
        </div>
      </Modal.Body>
